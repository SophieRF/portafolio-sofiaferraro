        ...
        <section
            ...
            <div className="text-center z-10 px-4">
                ...
                <p className="text-[#22333B] text-lg mb-8 max-w-4xl mx-auto">
                    ¡Hola! Soy Sofi, desarrolladora web Full-stack egresada de la Universidad Tecnológica Nacional en la Tecnicatura Universitaria en Programación. Me gusta crear aplicaciones intuitivas y armónicas. Mis principales cualidades son la organización y el trabajo metódico y ordenado.
                </p>
