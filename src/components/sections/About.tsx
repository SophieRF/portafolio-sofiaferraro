      ...
      <div className="max-w-3xl mx-auto px-4">
        ...
        <div className="rounded-xl p-6 border-white/10 border hover:-translate-y-1 transition-all">
          <p className="text-gray-800 text-center mb-4">
            Desarrolladora Full Stack, con experiencia en construcción de aplicaciones web MERN stack y React + SpringBoot
          </p>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="rounded-xl p-6 hover:-translate-y-1 transition-all mb-2">
